...
//    private static final String SQL_UPDATE= "SELECT * FROM et_sectors c where c.sector_id == ? ";
...
//    }
    ...
    public Integer create(Sector newSector) {
        try {
            PGpoint pGpoint = coordinatesConversorType.PointToPGpoint(newSector.getCenter_gps());
...
//    public void updateById(Sector sector) {
//        try {
...
//    }
    ...
    public void deleteAll() {
        ...
        if(count == 0)
            throw new EtResourceNotFoundException("Database already empty");
    }
...
//    }
    ...
    private RowMapper<Sector> sectorRowMapper = ((rs, rowNum) -> {
        ...
        java.awt.Point javaPoint = coordinatesConversorType.pGPointToPoint(pgPoint);
